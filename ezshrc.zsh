...
# export ZSH="$HOME/.oh-my-zsh"  # Now set in ~/.zshrc

# Set name of the theme to load. Optionally, if you set this to "random"
# it'll load a random theme each time that oh-my-zsh is loaded.
# See https://github.com/robbyrussell/oh-my-zsh/wiki/Themes

# ZSH_THEME="powerlevel10k/powerlevel10k"  # Now set in ~/.zshrc
...
alias a='eza -la --git -g --smart-group'  # clean readable listing
alias aa='eza -la --git -g --smart-group -s modified -r'  # sort by modified
